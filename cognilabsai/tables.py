...
cognilabsai_global_integration = Table(
    ...
    Column("cognilabs_telegram_token", Text, nullable=True),
    Column("cognilabs_channel_id", String(255), nullable=True),
    Column("frontend_base_url", String(1000), nullable=True),
    Column("instagram_followup_enabled", Boolean, nullable=False, default=False),
    Column("instagram_followup_delay_minutes", Integer, nullable=True),
    Column("instagram_followup_message", Text, nullable=True),
    ...
    Column("instagram_default_followup_step1_enabled", Boolean, nullable=False, default=True),
    ...
    Column("instagram_default_followup_step2_enabled", Boolean, nullable=False, default=True),
    Column("instagram_default_followup_step2_delay_minutes", Integer, nullable=True),
    Column("instagram_default_followup_step2_message", Text, nullable=True),
...
cognilabsai_conversation = Table(
    ...
    Column("follow_up_enabled", Boolean, nullable=False, default=False),
    Column("follow_up_mode", String(32), nullable=True),
    Column("follow_up_delay_minutes", Integer, nullable=True),
    Column("follow_up_message", Text, nullable=True),
    Column("follow_up_due_at", DateTime, nullable=True),
    Column("follow_up_sent_at", DateTime, nullable=True),
    Column("default_follow_up_last_step", Integer, nullable=False, default=0),
    Column("default_follow_up_due_at", DateTime, nullable=True),
    Column("default_follow_up_last_sent_at", DateTime, nullable=True),
