...
COGNILABS_TELEGRAM_TOKEN = os.environ.get("COGNILABS_TELEGRAM_TOKEN")
COGNILABS_CHANNEL_ID = os.environ.get("COGNILABS_CHANNEL_ID")
CIMS_BACKUP_BOT_TOKEN = os.environ.get("CIMS_BACKUP_BOT_TOKEN")
CIMS_BACKUP_CHAT_ID = os.environ.get("CIMS_BACKUP_CHAT_ID")
CIMS_BACKUP_THREAD_ID = os.environ.get("CIMS_BACKUP_THREAD_ID")
CIMS_BACKUP_MEDIA_PATHS = os.environ.get("CIMS_BACKUP_MEDIA_PATHS", "images,files")
ATTENDANCE_API_KEY = os.environ.get("ATTENDANCE_API_KEY")
CRM_CUSTOMER_API_KEY = os.environ.get("CRM_CUSTOMER_API_KEY")
